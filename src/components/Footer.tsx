      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-10 border-b border-[#1D7A72]/40">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-sm text-[#CFE6E2]/80 leading-relaxed">
              Certified doorstep sales, repair, and annual maintenance service
              for household and commercial RO water purifiers.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-[#CFE6E2]/80">
              ...
              <p className="flex items-start gap-2">
                ...
                <a
                  href="mailto:support@jalcarero.com"
                  className="hover:text-white transition-colors"
                >
              ...
              <p className="flex items-start gap-2">
                ...
                <span>
                  Shop No. 12, Jalcare Water Plaza, Sector 14 Main Road,
                  Landmark: Near Central Bank Branch
                </span>
              </p>
            </div>
          </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-[#CFE6E2]/60 gap-4">
          ...
          <p className="text-center sm:text-right">
            Serving households, offices, and commercial establishments with
